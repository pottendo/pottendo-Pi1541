...
"\t\t\t<br />\n"
"\t\t\t<h1 style=\"text-align:center\">Pi1541 Mount Images</h1>\n"
...
"\t\t\t<p>%s</p>\n"
"\t\t\t<hr style=\"border: 1px solid rgb(155, 155, 155); margin: 8px auto;\">\n"
"\t\t\t<form action=\"mount-imgs.html\" method=\"post\" name=\"manage_form\" accept-charset=\"UTF-8\" enctype=\"multipart/form-data\">\n"
"\t\t\t\t<div class=\"form-group\">\n"
"\t\t\t\t\t<h4 style=\"text-align: left;\">Mount Images</h4>\n"
"\t\t\t\t\t<div>\n"
"\t\t\t\t\t\t<table class=\"dirs\">\n"
"\t\t\t\t\t\t\t<tr valign=\"center\"><td>SDCard %s</td>\n"
"\t\t\t\t\t\t\t\t<td style=\"text-align:right;\">\n"
"\t\t\t\t\t\t\t\t\t<a href=\"mount-imgs.html?[MOUNT]&%s\">\n"
"\t\t\t\t\t\t\t\t\t\t<button type=\"button\">Mount image</button>\t\n"
"\t\t\t\t\t\t\t\t\t</a>\n"
"\t\t\t\t\t\t\t\t</td>\n"
"\t\t\t\t\t\t\t</tr>\n"
"\t\t\t\t\t\t</table>\n"
...
"\t\t\t\t\t\t\t\t<th>Image content</th>\n"
"\t\t\t\t\t\t\t</tr>\n"
"\t\t\t\t\t\t\t<tr valign=\"top\"><td>%s</td><td>%s</td>\n"
"\t\t\t\t\t\t\t\t<td style=\"font-size: 16px; font-family: 'C64 Pro Mono'; margin-left: 24px; padding-left: 24px; background-color: #2844c4; color: #9fade9; line-height:16px;\">%s</td>\n"
"\t\t\t\t\t\t\t</tr>\n"
"\t\t\t\t\t\t</table>\n"
"\t\t\t\t\t</div>\n"
"\t\t\t\t</div>\n"
